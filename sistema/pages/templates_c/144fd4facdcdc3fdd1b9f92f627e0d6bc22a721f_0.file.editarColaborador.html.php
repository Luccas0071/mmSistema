<?php
/* Smarty version 4.0.0, created on 2022-03-05 21:22:13
  from 'C:\xampp atualizado\htdocs\mmSistema\sistema\pages\templates\colaborador\editarColaborador.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_6223c675565558_93001714',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '144fd4facdcdc3fdd1b9f92f627e0d6bc22a721f' => 
    array (
      0 => 'C:\\xampp atualizado\\htdocs\\mmSistema\\sistema\\pages\\templates\\colaborador\\editarColaborador.html',
      1 => 1646511714,
      2 => 'file',
    ),
  ),
...
function content_6223c675565558_93001714 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
 language="JavaScript">
    jQuery.noConflict();
    indice = 0;
            ...
            <div class="row align-items-start">
                ...
                <div class="col-2">
                    <div class="padding-padrao">
                        ...
                        <input type="text" name="cpf" id="cpf" class="cpf form-control form-control-sm" value="" >
                    </div>
                </div>
                ...
                <div class="col-2">
                    <div class="padding-padrao">
                        ...
                        <input type="text" name="rg" id="rg" class="rg form-control form-control-sm" value="" >
                    </div>
                </div>
                <div class="col-2">
                    <div class="padding-padrao">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> 
                ...
                <div class="col-2">
                    <div class="padding-padrao">
                        ...
                        <input type="date" name="data" id="data" class="dataNascimento form-control form-control-sm" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-start">
                    ...
                    <div class="row align-items-start">
                        <div class="col-3">
                            <div class="padding-padrao">
                                ...
                                <input type="dddTelefone" MaxLength="2" name="dddTelefone" id="dddTelefone" class="dddTelefone form-control form-control-sm" value="" >
                            </div>
                        </div>
                        ...
                        <div class="col-9">
                            <div class="padding-padrao">
                                ...
                                <input type="text" name="telefone" id="telefone" class="telefone form-control form-control-sm" value="" >
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-start">
                        <div class="col-3">
                            <div class="padding-padrao">
                                ...
                                <input type="text" MaxLength="2" name="dddCelular" id="dddCelular" class="dddCelular form-control form-control-sm" value="" >
                            </div>
                        </div>
                        <div class="col-9">
                            <div class="padding-padrao">
                                <label for="celular" title="Celular" class="text-ellipsis">Celular:</label>
                                <input type="text" name="celular" id="celular" class="celular form-control form-control-sm" value="" >
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <div class="padding-padrao">
                        ...
                        <input type="text" name="email" id="email" class="email form-control form-control-sm" onkeypress="mascaraMoeda(this)" value="" >
                    </div>
                </div>
                <div class="col-2">
                    <div class="padding-padrao">
                        <label for="salario" title="Salário" class="text-ellipsis">Salário:</label>
                        <input type="text" name="salario" id="salario" class="salario form-control form-control-sm" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-start">
                <div class="col-2">
                    <div class="padding-padrao">
                        ...
                        <input type="text" name="cep" id="cep" class="cep form-control form-control-sm" value="" >
                    </div>
                </div>
                ...
                <div class="col-2">
                    <div class="padding-padrao">
                        ...
                        <input type="text" name="endereco" id="endereco" class="endereco form-control form-control-sm" value="" >
                    </div>
                </div>
                ...
                <div class="col-1">
                    <div class="padding-padrao">
                        ...
                        <input type="text" name="numero" id="numero" class="numero form-control form-control-sm" value="" >
                    </div>
                </div>
                <div class="col-2">
                    <div class="padding-padrao">
                        <label for="bairro" title="bairro" class="text-ellipsis">Bairro:</label>
                        <input type="text" name="bairro" id="bairro" class="bairro form-control form-control-sm" value="" >
                    </div>
                </div>
                <div class="col-2">
                    <div class="padding-padrao">
                        <label for="complemento" title="complemento" class="text-ellipsis">Complemento:</label>
                        <input type="text" name="complemento" id="complemento" class="complemento form-control form-control-sm" value="" >
                    </div>
                </div>
                <div class="col-1">
                    <div class="padding-padrao">
                        <label for="uf" title="Uf" class="text-ellipsis">Uf:</label>
                        <input type="text" name="uf" id="uf" class="uf form-control form-control-sm" value="" >
                    </div>
                </div>
                <div class="col-2">
                    <div class="padding-padrao">
                        <label for="municipio" title="municipio" class="text-ellipsis">Municipio:</label>
                        <input type="text" name="municipio" id="municipio" class="municipio form-control form-control-sm" value="" >
                    </div>
                </div>
            </div>
        </div>
